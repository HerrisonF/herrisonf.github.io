...
const AboutMeText = () => {
    return (
        <Container className="format-aboutme">
            <Row>
                <span className="text-green">Desenvolvedor Mobile e aspirante à tecnologias como Unity ou IA. Pretendo fazer a diferença por meio das minhas soluções criativas. </span>   
            </Row>
            <Row>
                ...
                <p>Apesar da experiência em outras áreas, tenho preferência e maior domínio na plataforma mobile. Minha perspectiva para o futuro é o aprimoramento do meu conhecimento em mobile, IA e Jogos. </p>
            </Row>
        </Container>  
    );
}
