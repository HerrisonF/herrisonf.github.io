    ...
    return (
        <Container>
            ...
            <Row>
                ...
                <p>Apesar da experiência em outras áreas, tenho gosto pela plataforma mobile e pela continuidade no conhecimento da área. Minhas metas para o futuro: Conhecer melhor sobre a inteligência artificial e possivelmente uma pós sobre o assunto. </p>
            </Row>
        </Container>  
    );
}
